...
export async function parse(
  ...
  const title = '张春桥同志关于二兵团上三司突然个别夺权的讲话';
...
敌人应该组织一个革命的市委，但要斗争中看一看，如光坐下来讨论三天，也讨论不出来什么结果。大家研究一下，前市委的常委到底留几个，一个也不留，这是不符合毛主席的方针。如果一个也不留的话，中央里有许多人也不在中央了。归根到底是权在谁的手里。党的八次代表大会时，我是代表，当时我不同意王明留在党内，后来经过主席的说服，我同意了主席的意见，现在一看到王明这名字，就想到王明的路线了，我们一定要站到主席的革命的路线上来。
...
二兵团的代表讲到①打内战②赤卫队问题③接管问题④肉类降价及把仓库的肉类拿出来卖时，张春桥讲：“把仓库的肉类拿出卖，并降低价格，是他们故意给我们制造麻烦。”
