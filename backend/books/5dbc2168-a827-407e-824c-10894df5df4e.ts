export default {
  entity: {
    id: '5dbc2168-a827-407e-824c-10894df5df4e',
    name: '学习文件（1）',
    internal: false,
    official: false,
    type: 'img',
    ...
    files: new Array(12)
      ...
      .map(
        (i, idx) =>
          `https://raw.githubusercontent.com/banned-historical-archives/banned-historical-archives1/main/5dbc2168-a827-407e-824c-10894df5df4e/${
            idx + 1
          }.`,
      )
      .join(','),
  ...
  path: '/archives1/5dbc2168-a827-407e-824c-10894df5df4e',
};
