  ...
  const subjects_results = important_subjects
    ...
    .map((i) => {
      if (i === '农业') return { name: '农业战线', type: TagType.subject };
        ...
        return { name: '清查五·一六', type: TagType.subject };
      else if (i === '红卫兵')
        return { name: '红卫兵运动', type: TagType.subject };
      else if (i === '大批判')
        return { name: '革命大批判', type: TagType.subject };
      else if (i === '大联合')
        return { name: '革命大联合', type: TagType.subject };
      else if (i === '三结合')
        return { name: '革命三结合', type: TagType.subject };
        ...
        return { name: '限制资产阶级法权', type: TagType.subject };
      else if (i === '清队')
        return { name: '清理阶级队伍', type: TagType.subject };
