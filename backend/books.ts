...
const books: Book[] = [
  {
    entity: {
      id: 'b869e58d-b5d5-4e2e-96cb-dc527251a56e',
      ...
      files: new Array(6)
        ...
        .map(
          (i, idx) =>
            `https://raw.githubusercontent.com/banned-historical-archives/banned-historical-archives1/main/b869e58d-b5d5-4e2e-96cb-dc527251a56e/${
              idx + 1
            }.jpg`,
        )
        .join(','),
    ...
    parser_option: {
      page_limits: [],
      ext: 'jpg',
      articles: [{"title":"张春桥同志十二月十日下午接见宣传系统代表讲话","authors":["张春桥"],"dates":[{"year":1967,"month":12,"day":10}],"page_start":1,"page_end":6}],
      ocr: undefined,
      ocr_exceptions: {},
    },
    parser: automation.parse,
    path: join(normalize(__dirname), '../public/books/archives1/b869e58d-b5d5-4e2e-96cb-dc527251a56e'),
  },
  {
    entity: {
