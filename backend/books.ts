...
const books: Book[] = [
  {
    entity: {
      id: 'b28b6fdd-99bf-45ec-9974-388567792a5f',
      name: '红旗一九六七年第十一期',
      internal: true,
      official: true,
      type: 'pdf',
      author: '',
      files: 'https://raw.githubusercontent.com/banned-historical-archives/banned-historical-archives2/main/b28b6fdd-99bf-45ec-9974-388567792a5f.pdf',
    },
    parser_option: {
      page_limits: [],
      ext: 'pdf',
    ...
    path: join(normalize(__dirname), '../public/archives2/b28b6fdd-99bf-45ec-9974-388567792a5f.pdf'),
  },
  {
    entity: {
