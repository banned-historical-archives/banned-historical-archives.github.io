...
const books: Book[] = [
  {
    entity: {
      id: 'd7087d90-5ed5-40ba-a00a-f404646a94a5',
      name: '红旗一九六六年第八期',
      internal: true,
      official: true,
      type: 'pdf',
      author: '',
      files: 'https://raw.githubusercontent.com/banned-historical-archives/banned-historical-archives2/main/d7087d90-5ed5-40ba-a00a-f404646a94a5.pdf',
    },
    parser_option: {
      page_limits: [],
      ext: 'pdf',
    ...
    path: join(normalize(__dirname), '../public/books/archives2/d7087d90-5ed5-40ba-a00a-f404646a94a5.pdf'),
  },
  {
    entity: {
