...
const books: Book[] = [
  {
    entity: {
      id: '9864239a-f77c-4289-a9a5-bd93295a108e',
      name: '论个人在历史上的作用问题（生活·读书·新知三联书店1964年版）',
      internal: true,
      official: true,
      type: 'pdf',
      author: '',
      files: 'https://raw.githubusercontent.com/banned-historical-archives/banned-historical-archives2/main/9864239a-f77c-4289-a9a5-bd93295a108e.pdf',
    },
    parser_option: {
      page_limits: [],
      ext: 'pdf',
    ...
    path: join(normalize(__dirname), '../public/books/archives2/9864239a-f77c-4289-a9a5-bd93295a108e.pdf'),
  },
  {
    entity: {
