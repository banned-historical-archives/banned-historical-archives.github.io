...
const books: Book[] = [
  {
    entity: {
      id: '73ff309e-a1c3-4af6-b0df-0a1d103a33e4',
      name: '红旗一九六七年第十一期',
      internal: true,
      official: true,
      type: 'pdf',
      author: '',
      files: 'https://raw.githubusercontent.com/banned-historical-archives/banned-historical-archives2/main/73ff309e-a1c3-4af6-b0df-0a1d103a33e4.pdf',
    },
    parser_option: {
      page_limits: [],
      ext: 'pdf',
    ...
    path: join(normalize(__dirname), '../public/archives2/73ff309e-a1c3-4af6-b0df-0a1d103a33e4.pdf'),
  },
  {
    entity: {
